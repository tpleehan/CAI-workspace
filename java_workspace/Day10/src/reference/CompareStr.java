	...
	public static void main(String[] args) {
		...
		/*
		 - String은 객체 타입이다.
		   ...
		   문자열을 다룰 수 있는 여러 기능을 제공한다.
		     
		 - String 변수에는 문자열이 아니라 문자열 객체의 주소값이 들어 있다.
		   평소 String 변수를 그냥 사용해도 문자열이 제대로 나오는 것은
		   자바에서 편하게 사용하도록 제공하고 있고, 실제로는 주소값으로 접근해서 사용하는 것이다.
		 
		 - == 연산자로 변수의 값 자체를 비교하는 것은 주소값을 비교하는 의미와 같다.
		   문자열의 내용 값 그 자체를 비교할 때는 equals() 메서드를 사용해야 한다.
		 */
