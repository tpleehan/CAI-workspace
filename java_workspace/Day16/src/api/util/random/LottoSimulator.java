...
public class LottoSimulator {
	...
	public static int[] createLotto() {
		...
		/*
		 * - 1~45 범위의 난수 6개를 생성하셔서 lotto 배열에 넣어서 리턴
		 * - 난수끼리는 중복이 발생하면 안됨.
		 *   난수를 생성한 후에 생성된 난수가 이미 배열에 있는지를 확인하여, 
		 *   이미 존재한다면 다시 생성해서 검사해 주시고 존재하지 않는다면 배열에 추가한다.
		 * - return 전에 배열을 정렬해서 리턴 (while으로 작성 for로 작성해도 된다.)
		 */
