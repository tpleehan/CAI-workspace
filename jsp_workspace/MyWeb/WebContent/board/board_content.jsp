            ...
            <div class="col-md-offset-1 col-md-10">
                <div class="panel">
                    <div class="panel-heading text-white" style="background: #F8F8FF;">
                        <div class="row">
                            <div class="col-md-6">
                                <h2 style="padding-left: 10px;"><!-- 글 제목 -->${content.title}</h2>
                            </div>
                            <div class="col-md-offset-3 col-md-3">
                                <div style="padding-top: 10px; font-size: 1.5em"><!-- 작성자 란 -->작성자: ${content.writer}</div>
                                <div>
                                	조회수: ${content.hit}
                                </div>
                            </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-offset-1 col-md-5">
                                <p class="last-update">
                                	<!-- 글 작성 시간 --> 
                                	<fmt:formatDate value="${content.regDate}" pattern="yyyy년 MM월 dd일 HH시 mm분"/>
                                </p>
                            </div>
                            <div class="btn-group col-md-offset-1 col-md-5">
                                <a class="btn btn-info" href="/MyWeb/list.board?page=${param.page}&countPerPage=${param.countPerPage}">목록 보기</a>
                            <c:choose>
