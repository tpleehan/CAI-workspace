                  ...
                  <table
                     ...
                     <tr>
                        <td><input type="email" name="email" value="${user.email}"
                           class="form-control" 
                           style="margin-bottom: 25px; width: 100%; height: 40px; border: 1px solid #d9d9de"
                           placeholder="ex) user@email.com"></td>
                     </tr>
                     <tr>
                        <td style="text-align: left">
                     ...
                     <tr>
                        <td><input type="text" name="address" value="${user.address}"
                           class="form-control" 
                           style="margin-bottom: 25px; width: 100%; height: 40px; border: 1px solid #d9d9de"
                           placeholder="ex) 서울특별시 마포구"></td>
                     </tr> 
                     
                     <tr>
                        <td style="width: 100%; text-align: center; colspan: 2;">
                        	<input type="submit" value="정보 수정" class="btn btn-primary btn-lg" onclick="return confirm('수정하시겠습니까?')"> &nbsp;&nbsp;
