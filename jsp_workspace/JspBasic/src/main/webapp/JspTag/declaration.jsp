<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%!
    	 ...
    	 * 선언자에 작성된 코드는 jsp파일이 클래스로 변환될 때 실제 클래스 블록에서 선언된다.
    	 * 해당 클래스로 객체가 생성될 때 멤버변수(속성), 메서드(기능)로 동작하기 때문에
    	 * 객체가 소멸하지 않는 이상 요청이 들어온다면 값을 계속 누적할 수 있고 메서드 호출 또한 가능하다.
    	 */
    	public int i;
    ...
    <%
    	 ...
    	 * 스크립틀릿에 작성한 내용은 jsp파일이 클래스로 변환될 때 jsp_service()라는 메서드 내부에 작성된다.
