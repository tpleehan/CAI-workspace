<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%--
		- 생성된 login_cookie 쿠키를 검색하여 쿠키가 이미 존재한다면
		  ...
		  welcome 페이지로 이동할 수 있는 링크를 제공
 
		- login_cookie가 없는 사용자는 로그인 입력창이 등장하도록 구성
     --%>
...
<body>
	...
	<% if (!flag) { %>
		<form action="cookie_login_con.jsp" method="post">
			...
			<input type="checkbox" name="id_remeber" value="true"> 
			<small style="font-size: 0.7em">아이디 저장</small>
			<br>
	...
	<% } else { %>
		...
		<a href="cookie_welcome.jsp"> WelCome 화면으로 돌아가기 </a>
