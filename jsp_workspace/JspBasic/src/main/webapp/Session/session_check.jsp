...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	 ...
    	 *	 getAttribute()를 사용하고, 매개값으로 가져올 세션 데이터의 이름을 사용한다.
    	 */
    	 
    	 // getAttribute의 리턴타입은 Object이기 때문에
    	 // 강제 형 변환을 통해 타입을 내려서 준비한 변수에 대입해야 한다.
    	 ...
    	 out.print("삭제 후 nick의 값: " + nick + "초 <br>");
    	 out.print("--------------------------------<br>");
    	 
    	 // 모든 세션 데이터를 삭제
    	 session.invalidate();
    	 
    	 // 해당 페이지에서는 더 이상 세션 객체를 사용할 수 없으므로 아래의 코드는 에러를 발생한다.
    	 // 새로운 요청이 다시 들어오기 전까지는 세션 객체를 사용할 수 없다.
