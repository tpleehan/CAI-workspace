...
public class BoardDAO implements IBoardDAO {
	...
	public void regist(String writer, String title, String content) {
		...
		String sql = "INSERT INTO mvc_board (board_id, writer, title, content)"
	...
	public BoardVO contentBoard(int bId) {
		...
		String sql = "SELECT * FROM mvc_board WHERE board_id = ?";
	...
	public void deleteBoard(int bId) {
		String sql = "DELETE FROM mvc_board WHERE board_id = ?";
	...
	public List<BoardVO> searchBoard(String keyword, String category) {
		...
		String sql = "SELECT * FROM mvc_board WHERE " + category + " LIKE ? ORDER BY board_id DESC";
