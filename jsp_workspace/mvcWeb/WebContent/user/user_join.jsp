		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-9 col-sm-12 join-form">
					...
					<form action="/mvcWeb/join.user" method="post" name="reg_form">
						<div class="form-group">
							<label for="id">아이디</label> <input type="text"
								class="form-control" name="id" id="id"
								placeholder="아이디 (영문포함 4~12자 이상)">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="password-confrim">비밀번호 확인</label> <input
								...
								name="pw_check" placeholder="비밀번호를 확인해주세요.">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input class="form-control sel" placeholder="010" name="phone" maxlength='3' onkeyup="this.value=this.value.replace(/[^0-9]/g,'');">
							- 
							<input class="form-control sel" placeholder="xxxx" name="phone2" maxlength='4' onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"> 
							- 
							<input class="form-control sel" placeholder="xxxx" name="phone3" maxlength='4' onkeyup="this.value=this.value.replace(/[^0-9]/g,'');">
								
						</div>
						<div class="form-group">
							<label for="hp">이메일</label><br> <input
								class="form-control sel" name="email">@ <select
								class="form-control sel" name="emailSel">
