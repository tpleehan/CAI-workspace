                                ...
                                <div class="my-account">
                                    <div class="my-account-margin">
                                        <ul class="my-account-part">
                                            <li class="my-account-delete">계정 삭제하기</li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="account__wrapper">
                                        <div class="delete_box">
                                            <div class="account-delete-box1">
                                                <p>회원 탈퇴 전 아래 사항을 꼭 확인해 주시기 바랍니다.<br>
                                                        - 회원 탈퇴 시, 가지고 계신 포인트 및 쿠폰은 모두 삭제되며 복구되지 않습니다.<br>
                                                        환불이 가능한 포인트의 경우에는 고객센터를 통해 먼저 환불 요청을 진행해 주시기 바랍니다.<br>
                                                        - 회원 탈퇴 시, 패스트캠퍼스에 등록된 회원님의 개인정보는 모두 삭제되며 복구되지 않습니다.<br>
                                                        단, 관계법령에 따라 회사가 보관하여야 하는 정보는 일정 기간 보관 처리합니다.<br>
                                                        - 부당한 목적으로 탈퇴 후 재가입을 한 경우에는 이용에 제한이 있을 수 있습니다. 
                                                </p>
                                            </div> 
                                        ...
                                        <div class="delete-checkbox">
                                            ...
                                            <ul class="checkbox-ul">
                                                <p>
                                                    <span><input type="checkbox" id="delete-agree"> 위 안내사항을 확인하였으며, 탈퇴 시 계정에 남아 있는 정보 및 잔여 포인트, 쿠폰 등은 복구되지 않음을 인지하였으며 이에 동의합니다.</span>
                                                </p>
                                            </ul>
                                            <div class="button-class">
                                                <div class="button-first"> 
                                                    <button type="button" class="ac-button is-lg is-solid is-primary e-cancle-up-button form__button ">취소</button>
                                                </div>
                                                <div class="button-second">
                                                    <button type="button" class="ac-button is-lg is-solid is-second e-delete-up-button form__button ">계정 삭제</button>
                                                </div>
                                            </div>
                                            </div>
                                    </div>
